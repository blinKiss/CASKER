'''
    ...
    * 주소록 정보
    ...
    - 이름, 전화번호, 주소 정보를 저장
    ex)
    김범수, 010-1234-1234, 서울시 보고싶구
    유나얼, 010-1234-4321, 서울시 일년됐구
    박효신, 010-1234-5678, 서울시 해줄수없구
...
'''
    sys 모듈
    : 인터프리터가 제공하는 변수와 함수를 직접 제어할 수 있게 해주는 모듈
    sys.exit() : 프로그램 종료
'''
...
class AddressBook:
    ...
    def file_reader(self):
        ...
        try:
            ...
            while True:
                ...
                if not buffer:
                    break
                # 김범수,010-1234-1234,서울시 마포구
                # split() -> ['김범수', '010-1234-1234', '서울시 마포구\n']
                name = buffer.split(',')[0]
    ...
    def file_generate(self):
        try:
            ...
            # address_list를 반복하여, 모든 연락처 정보를 .csv 파엘이 출력
    ...
    def run(self):
        while True:
            choice = AddressBook.menu()          # 입력한 메뉴 번호
